...
The brief asks how AI tools were used. Short version here; the full record with prompt examples, what was discarded and where the AI was wrong is in `AI_USAGE.md`; slides 15 to 17 of the technical deck (`docs/13-debrief/technical-deck/`) cover the same ground, including how the debrief videos were made.
