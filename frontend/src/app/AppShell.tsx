...
export function AppShell() {
  ...
  const nav = (
    ...
    >
      {!collapsed ? (
        <div className="px-3 pb-1 pt-2 text-[11px] font-semibold uppercase tracking-[0.06em] text-text-3">
      ...
      {!collapsed ? (
        <div className="mt-auto border-t border-line p-3 text-xs leading-[18px] text-text-3">
          © 2026 PermitFlow
        </div>
      ) : null}
    </nav>
