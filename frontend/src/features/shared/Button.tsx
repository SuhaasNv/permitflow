...
export const buttonClasses = (
  ...
  cn(
    ...
    variant === "secondary" &&
      "border-line-strong bg-surface text-text shadow-[var(--shadow-1)] hover:bg-surface-2",
    variant === "ghost" &&
      "border-transparent bg-transparent text-text-2 hover:bg-neutral-soft hover:text-text",
    variant === "danger" &&
      "border-line-strong bg-surface text-text-2 hover:border-error-line hover:bg-error-soft hover:text-error",
    extra,
  );
