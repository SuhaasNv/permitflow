...
Stack (unchanged from ADR-009): React 18, TypeScript strict, Vite, Tailwind, TanStack Query, React Hook Form, Zod. This document says how that stack implements the screens in `SCREEN_INVENTORY.md` against the API in `docs/architecture/ARCHITECTURE.md`.
