...
| Officer comments prominently at the top | Met | `FeedbackNotice.tsx` above the application on the operator page | `ApplicationPage.test.tsx` | Scenario 03 |
