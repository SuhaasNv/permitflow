...
|----------|---------------|
| `THREAT_MODEL.md` | Assets, trust boundaries, threats T1 to T22 (plus T1a): the risk, the control planned for the MVP, how it was validated, and the production gap where one remains |
