...
- **Gap:** Attachments are not scanned for malware and images keep their metadata until US-085 lands (T25 gap closed there); an officer can withdraw a request after the operator has typed an answer, which the operator sees as "No longer needed" with their draft kept.
