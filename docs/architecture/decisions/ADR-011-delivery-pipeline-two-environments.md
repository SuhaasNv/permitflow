...
### Option C: Option B plus promptfoo for the prompt, LangSmith tracing, SAST (Semgrep/CodeQL) and a staging environment
...
- Production: variables, volume, domains and the approval rule are configured; first deploy at v0.3.0 (`docs/operations/OPERATIONS.md`).
