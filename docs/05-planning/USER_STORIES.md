...
- Definition of Done: 752 backend and 152 frontend tests green; CI green on `main` through the protected path; `CHANGELOG.md` "Review fixes (20 Sep 2026)" lists every change; scores recorded in `docs/11-reviews/FINAL_REVIEW.md`.
