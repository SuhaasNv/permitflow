...
//   cd frontend && node ../docs/12-demo/documents/generate.mjs
//
...
try {
  ...
  console.error('Run this script from the frontend folder: cd frontend && node ../docs/12-demo/documents/generate.mjs');
  process.exit(1);
}
