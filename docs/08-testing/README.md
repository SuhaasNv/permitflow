...
The tests themselves: `backend/tests/`, `frontend/src/**/*.test.tsx`, `frontend/e2e/`, `backend/evals/`. CI runs all of it: `.github/workflows/ci.yml` and `ai-gate.yml`. Manual acceptance is a separate record: `../10-uat/`.
