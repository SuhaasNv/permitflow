...
| Frontend (`src/**/*.{ts,tsx}` minus tests, fixtures and `main.tsx`) | `npm run test:coverage` (v8, `coverage.include` in `vite.config.ts`) | 82 % statements, 84 % lines, 79 % functions, 73 % branches, 226 tests (21 Sep 2026) | statements 80, lines 80, functions 75, branches 65 |
