...
Backend total on 20 Sep 2026 (after the review fixes, the final check, US-076 and US-077): 763 test cases from 174 test functions; the state-machine sweep in `test_workflow.py` alone contributes 588 parametrised cases, so the count of distinct tests is the smaller number. Sprint 3 close was 748, Sprint 2 close 620.
