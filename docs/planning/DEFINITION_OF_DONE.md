...
- [ ] Uploads and user content handled per `docs/security/THREAT_MODEL.md`.
- [ ] Logs contain identifiers, not payloads or document text.

## Operations and documentation
- [ ] Environment variables documented in `docs/operations/OPERATIONS.md` and README if added.
