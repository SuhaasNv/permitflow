...
- Definition of Done: 747 backend tests green; the built frontend image serves the rendered CSP and the bundle runs under it with zero violations; CI audit job green and blocking; review document complete.
