...
| FR-043 | The site visit is arranged inside the case: the officer proposes a date and slot, the operator accepts or proposes another date with a reason, the officer accepts, keeps or proposes again, either side can reschedule before the date, the officer can confirm after three working days of silence, and the visit is marked done only once confirmed. (v0.4.0, US-084) | Not in the brief; owner's product decision (20 Sep 2026) |
