...
- `docs/debrief/`: the pitch deck (11 slides) and the technical deck (17 slides) as PowerPoint with handout PDFs, the launch video (70.7 s) with its poster, the narrated walkthrough (4 min 36 s) and the technical video (1 min 28 s), videos in Git LFS. Diagrams (solution architecture, deployment, CI/CD) added under `docs/architecture/diagrams/views/` and embedded in `ARCHITECTURE.md`, `OPERATIONS.md` and the README; the launch poster heads the README. No product code changed.
